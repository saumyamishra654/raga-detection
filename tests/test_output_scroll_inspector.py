...
class ScrollInspectorHtmlTests(unittest.TestCase):
    def test_scroll_plot_html_contains_inspector_elements_and_hooks(self) -> None:
        ...
        self.assertRegex(html, r'id="sp_[0-9a-f]{6}-hover-v-guide"')
        self.assertRegex(html, r'id="sp_[0-9a-f]{6}-hover-h-guide"')
        ...
        self.assertIn("const hoverPitchTimestamps =", html)
        self.assertIn("const hoverPitchMidi =", html)
        ...
        self.assertIn("function nearestPitchSample", html)
        self.assertIn("function midiToY", html)
        self.assertIn("function showHoverGuides", html)
        self.assertIn("function hideHoverGuides", html)
        self.assertIn("function hoverPitchLineHtml", html)
        self.assertIn("Y-axis pitch @ t:", html)
        self.assertIn("Nearest transcribed note", html)
        ...
        self.assertIn("function addManagedListener(", html)
        self.assertIn("addManagedListener(container, \"mousedown\", onContainerMouseDown)", html)
        self.assertIn("addManagedListener(container, \"mousemove\", onContainerMouseMove)", html)
        self.assertIn("addManagedListener(container, \"mouseleave\", onContainerMouseLeave)", html)
        self.assertIn("addManagedListener(document, \"mouseup\", onDocumentMouseUp)", html)
        self.assertIn("raga-scroll-selection-clear", html)
        self.assertIn("raga-scroll-overlay-activate", html)
        self.assertIn("function startSyncInstance()", html)
        self.assertIn("function stopSyncInstance()", html)
        self.assertIn("function isInstanceVisibleAndActive()", html)
        self.assertIn("function scheduleHoverRender(", html)
        self.assertIn("window.__RAGA_SYNC_DUMP__", html)
        self.assertIn("window.__RAGA_SYNC_METRICS__", html)
        self.assertNotIn("updateSync();", html)
        self.assertNotIn("renderHoverTooltip(xFromEvent(e), yFromEvent(e));", html)
